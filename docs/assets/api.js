window.Api = (function api() {
  ...
  return {
    ...
    membersBulkAction: (guildId, payload) => request(`/api/guilds/${guildId}/members/bulk-action`, { method: 'POST', body: JSON.stringify(payload) }),
    serverWebhooks: (guildId) => request(`/api/guilds/${guildId}/server-webhooks`),
    deleteServerWebhook: (guildId, webhookId) => request(`/api/guilds/${guildId}/server-webhooks/${webhookId}`, { method: 'DELETE' }),
    ...
    purgeMessages: (guildId, channelId, filter) => request(`/api/guilds/${guildId}/channels/${channelId}/purge`, { method: 'POST', body: JSON.stringify(filter) }),
    ...
    cleanOrphanPermissions: (guildId) => request(`/api/guilds/${guildId}/permissions/clean-orphans`, { method: 'POST' }),
    ...
    embedTrash: (guildId) => request(`/api/guilds/${guildId}/embedtrash`),
    restoreEmbedTrash: (guildId, trashId) => request(`/api/guilds/${guildId}/embedtrash/${trashId}/restore`, { method: 'POST' }),
